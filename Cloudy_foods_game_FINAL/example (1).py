...
class Food(pygame.sprite.Sprite):
    def __init__(self, xpos, ypos, speed) :
        ...
        Food_images = ('food1.png','food2.png','food3.png','food4.png','food5.png','food6.png','food7.png',
...
def game_loop() :
    ...
    while not done :
        ...
        if random.randint(1, occur_prob) ==1:
            for i in range(occur_of_foods): # 음식생성
                speed = random.randint(min_food_speed, max_food_speed)
                food = Food(random.randint(0,WINDOW_WIDTH - 30), 0, speed) #음식이 윈도우 끝에 있으면 안보이니까 -30해서 이동시킨 것.
                foods.add(food)
        ...
        for missile in missiles:
            food = missile.collide(foods) #미사일을 음식이랑 다 충돌했는지 비교해봐서 충돌했으면 반환을 해주는 것
            if food:
                missile.kill()
                food.kill()
